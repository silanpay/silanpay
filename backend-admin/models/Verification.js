...
const VerificationSchema = new mongoose.Schema(
    {
        ...
        // Individual flags for quick access
        emailVerified: { type: Boolean, default: false },
        businessPanVerified: { type: Boolean, default: false },
        businessDetailsVerified: { type: Boolean, default: false },
        registrationDetailsVerified: { type: Boolean, default: false },
        signatoryDetailsVerified: { type: Boolean, default: false },
        bankDetailsVerified: { type: Boolean, default: false },
        documentsUploaded: { type: Boolean, default: false },
        websiteDetailsVerified: { type: Boolean, default: false },
        additionalDetailsVerified: { type: Boolean, default: false },
