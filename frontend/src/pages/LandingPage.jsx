...
$payment = $silanpay->createPayment([
  ...
  python: `from silanpay import SilanPay
...
export default function LandingPage() {
  ...
  useLayoutEffect(() => {
    const ctx = gsap.context(() => {
      gsap.set(".gsap-show", { opacity: 1, visibility: "visible" });
...
gsap.utils.toArray(".feature-gsap-card").forEach((card, index) => {
  gsap.fromTo(
    card,
    {
      opacity: 0,
    ...
    },
    {
      ...
      gsap.utils.toArray(".phonepe-card").forEach((card, index) => {
        gsap.fromTo(
          card,
          {
            opacity: 0,
  ...
  const services = [
    ...
    },
    {
      ...
      title: "Enterprise Solutions",
      description:
        "Custom payment solutions for large enterprises and business with advanced reporting and analytics",
    },
  ];
  ...
  const steps = [
    ...
    },
    {
      ...
      description:
        "Copy your API keys and integrate using our SDKs. Test in sandbox mode before going live.",
      details: ["Get API credentials", "Choose SDK", "Test transactions"],
      time: "5 minutes",
      icon: Code,
    },
    {
      ...
      description:
        "Switch to production mode and start accepting real payments. Monitor everything from dashboard.",
      details: ["Enable live mode", "Configure webhooks", "Start payments"],
      time: "2 minutes",
      icon: CheckCircle,
    },
  ];
  ...
  const advancedFeatures = [
    ...
    },
    {
      ...
      description:
        "Automated settlement reconciliation that saves hours of manual work",
      points: ["Instant settlement matching", "Discrepancy alerts", "Reports"],
    },
    {
      icon: Bell,
      title: "Smart Notifications",
      ...
      description:
        "Multi-channel alerts for transactions, settlements, and important events",
      points: ["Email & SMS alerts", "Webhook integration", "Custom rules"],
    },
    {
      icon: Users,
      title: "Team Management",
      ...
      description:
        "Role-based access control with detailed permissions for team members",
      points: ["Multi-user accounts", "Custom roles", "Audit trail"],
    },
    {
      icon: TrendingUp,
      title: "Business Intelligence",
  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-[#F4FAFF] text-[#202943]">
      <style>{`
        @keyframes marquee {
      ...
      {/* HEADER */}
      <header className="fixed top-0 left-0 z-50 w-full border-b border-white/50 bg-white/80 backdrop-blur-xl">
        <div className="flex items-center justify-between px-5 py-4 mx-auto max-w-7xl">
          ...
          {/* Desktop Nav */}
          <nav className="items-center hidden gap-8 text-base font-black lg:flex">
            <a href="#features" className="hover:text-[#2199DF]">Features</a>
            <a href="#services" className="hover:text-[#2199DF]">Services</a>
            <a href="#integration" className="hover:text-[#2199DF]">Integration</a>
            <a href="#pricing" className="hover:text-[#2199DF]">Pricing</a>
            <a href="#contact" className="hover:text-[#2199DF]">Contact</a>
          </nav>
          ...
          <div className="items-center hidden gap-3 lg:flex">
            <Link
              to="/login"
              className="px-5 py-2.5 font-black text-[#202943] border border-gray-200 rounded-full hover:border-[#2199DF]"
            >
              Login
            </Link>
            ...
            <Link
              to="/register"
              className="px-6 py-3 font-black text-white rounded-full bg-gradient-to-r from-[#202943] to-[#2199DF]"
            >
              Sign Up
            </Link>
          </div>
          ...
          <div className="flex items-center gap-3 lg:hidden">
            <Link
              to="/login"
              className="px-4 py-2 text-sm font-black text-[#202943] border rounded-full"
            >
              Login
            </Link>
            ...
            <button
              ...
              className="p-2 rounded-xl bg-[#F4FAFF]"
            >
              {menuOpen ? (
                <X className="w-6 h-6 text-[#202943]" />
              ) : (
                <Menu className="w-6 h-6 text-[#202943]" />
              )}
            </button>
          </div>
        </div>
        ...
        {/* Mobile Menu */}
        {menuOpen && (
          <div className="px-5 pb-5 bg-white border-t lg:hidden">
            <div className="flex flex-col gap-4 pt-4 font-black">
              ...
              <Link
                to="/register"
                className="py-3 mt-2 text-center text-white rounded-2xl bg-gradient-to-r from-[#202943] to-[#2199DF]"
              >
                Sign Up
              </Link>
            </div>
      ...
      {/* HERO - COMPLETELY DIFFERENT STRUCTURE */}
      <section className="relative min-h-screen pt-32 pb-20 overflow-hidden bg-[#07111f] text-white">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(33,153,223,0.45),transparent_35%),radial-gradient(circle_at_bottom_left,rgba(33,136,200,0.25),transparent_35%)]" />
        <div className="absolute inset-0 opacity-20 bg-[linear-gradient(to_right,#ffffff12_1px,transparent_1px),linear-gradient(to_bottom,#ffffff12_1px,transparent_1px)] bg-[size:70px_70px]" />

        <div className="relative z-10 grid items-center gap-12 px-5 mx-auto max-w-7xl lg:grid-cols-[1.05fr_0.95fr]">
          <div>
            <div className="hero-reveal inline-flex items-center gap-2 px-4 py-2 mb-7 text-sm font-black border rounded-full border-white/15 bg-white/10 backdrop-blur-xl">
              <Shield className="w-4 h-4 text-[#2199DF]" />
              Trusted by 1,000+ Businesses
            </div>

            <h1 className="hero-reveal max-w-4xl text-5xl font-black leading-tight sm:text-6xl lg:text-7xl">
              Secure Payments
              <span className="block text-transparent bg-clip-text bg-gradient-to-r from-[#2199DF] to-white">
                Made Simple
              </span>
            </h1>

            <p className="hero-reveal max-w-2xl mt-6 text-lg leading-relaxed text-white/70">
              Accept payments seamlessly with our reliable UPI, QR codes, and
              payment gateway solutions. Start processing payments in minutes.
            </p>

            <div className="hero-reveal flex flex-col gap-4 mt-9 sm:flex-row">
              <Link
                to="/register"
                className="inline-flex items-center justify-center gap-2 px-8 py-4 font-black text-white transition rounded-2xl bg-gradient-to-r from-[#2188C8] to-[#2199DF] hover:scale-105"
              >
              ...
              <a
                href="#integration"
                className="inline-flex items-center justify-center px-8 py-4 font-black border rounded-2xl border-white/15 bg-white/10 backdrop-blur-xl"
              >
                View Integration
              </a>
            </div>

            <div className="hero-reveal grid grid-cols-2 gap-4 mt-12 md:grid-cols-4">
              {stats.map((item) => (
                <div
                  key={item.label}
                  className="p-5 border rounded-3xl border-white/10 bg-white/10 backdrop-blur-xl"
                >
                  <item.icon className="w-6 h-6 mb-3 text-[#2199DF]" />
                  <h3 className="text-3xl font-black">{item.number}</h3>
          ...
          <div className="hero-card relative">
            <div className="absolute -top-8 -left-8 w-32 h-32 bg-[#2199DF]/30 rounded-full blur-3xl" />

            <div className="relative p-4 border shadow-2xl border-white/10 bg-white/10 backdrop-blur-2xl rounded-[2.2rem]">
              <div className="p-5 bg-white shadow-2xl rounded-[1.8rem] text-[#202943]">
                <div className="p-6 text-white rounded-[1.5rem] bg-gradient-to-br from-[#202943] to-[#2199DF]">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm text-white/70">SilanPay Checkout</p>
                      <h3 className="mt-1 text-4xl font-black">₹2,499.00</h3>
                    </div>
                ...
                <div className="grid grid-cols-3 gap-3 mt-5">
                  {[
                    ...
                    <button
                      ...
                      className={`flex flex-col items-center gap-1 p-4 font-black transition rounded-2xl ${selectedPaymentMethod === item.id
                          ? "bg-[#2199DF] text-white"
                          : "bg-[#F4FAFF] text-[#202943]"
                        }`}
                    >
                ...
                <div className="p-5 mt-5 border border-blue-100 rounded-3xl bg-[#F4FAFF] min-h-[170px]">
                  {selectedPaymentMethod === "upi" && (
                    <div>
                      <label className="text-sm font-black">Enter UPI ID</label>
                      <input
                        placeholder="yourname@upi"
                        className="w-full px-4 py-3 mt-3 bg-white border outline-none rounded-2xl focus:border-[#2199DF]"
                      />
                      <button className="w-full py-3 mt-4 font-black text-white bg-[#202943] rounded-2xl">
                        Verify UPI ID
                      </button>
                    </div>
                  )}
                  ...
                  {selectedPaymentMethod === "qr" && (
                    <div className="text-center">
                      <QrCode className="w-24 h-24 mx-auto text-[#2199DF]" />
                      <h4 className="mt-3 font-black">Scan QR Code</h4>
                  ...
                  {selectedPaymentMethod === "cards" && (
                    <div className="space-y-3">
                      <input
                        placeholder="Card Number"
                        className="w-full px-4 py-3 bg-white border outline-none rounded-2xl"
                      />
                      <div className="grid grid-cols-2 gap-3">
                        <input
                          placeholder="MM/YY"
                          className="px-4 py-3 bg-white border outline-none rounded-2xl"
                        />
                        <input
                          placeholder="CVV"
                          className="px-4 py-3 bg-white border outline-none rounded-2xl"
            ...
            <div className="absolute p-4 text-[#202943] bg-white shadow-2xl -bottom-8 -left-8 rounded-2xl">
      ...
      {/* CERTIFICATES */}
      <section className="py-8 overflow-hidden bg-white border-y">
        <p className="mb-5 text-xs font-black tracking-[0.25em] text-center text-gray-400 uppercase">
          Certifications & Recognitions
        </p>
          ...
          {[...certificates, ...certificates, ...certificates].map(
            (cert, index) => (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex items-center justify-center h-20 px-8 mx-3 bg-[#F4FAFF] rounded-2xl"
              >
                <img
                  src={cert.src}
                  alt={cert.alt}
                  className="object-contain w-auto h-10 grayscale hover:grayscale-0"
                />
              </a>
            )
          )}
      ...
      {/* FEATURES - PREMIUM GSAP STYLE */}
<section
  id="features"
  ref={featuresSectionRef}
  className="relative py-24 overflow-hidden bg-[#07111f] text-white"
>
  <div className="absolute top-0 right-0 w-[420px] h-[420px] bg-[#2199DF]/20 rounded-full blur-3xl"></div>
  <div className="absolute bottom-0 left-0 w-[420px] h-[420px] bg-[#2188C8]/10 rounded-full blur-3xl"></div>

  <div className="relative z-10 px-5 mx-auto max-w-7xl">
    <div className="grid items-start gap-14 lg:grid-cols-[0.9fr_1.1fr]">
      {/* LEFT STICKY CONTENT */}
      <div className="features-left lg:sticky lg:top-32">
        <p className="mb-4 text-sm font-black tracking-widest text-[#2199DF] uppercase">
          Why Choose SilanPay
        </p>
        ...
        <p className="max-w-xl mt-6 text-lg leading-relaxed text-white/65">
          Everything you need to accept payments, manage transactions, and grow
          your business - all in one powerful platform.
        </p>

        <div className="grid grid-cols-2 gap-4 mt-10">
          {["Secure", "Fast", "Scalable", "Support"].map((item) => (
            <div
              key={item}
              className="p-4 border rounded-2xl border-white/10 bg-white/10 backdrop-blur-xl"
            >
              <CheckCircle className="w-5 h-5 mb-2 text-[#2199DF]" />
      ...
      <div className="grid gap-6">
        {features.map((feature, index) => (
          <div
            key={feature.title}
            className="feature-gsap-card group relative overflow-hidden p-7 bg-white text-[#202943] rounded-[2rem] shadow-2xl"
          >
            <div className="absolute top-0 right-0 w-40 h-40 bg-[#2199DF]/10 rounded-full -mr-16 -mt-16 group-hover:scale-150 transition-transform duration-700"></div>

            <div className="relative z-10 grid gap-5 sm:grid-cols-[auto_1fr_auto] sm:items-center">
              <div className="flex items-center justify-center w-16 h-16 text-white rounded-2xl bg-gradient-to-r from-[#202943] to-[#2199DF] shadow-lg group-hover:rotate-6 transition">
                <feature.icon className="w-8 h-8" />
              </div>

              <div>
                <p className="mb-1 text-xs font-black tracking-widest text-[#2199DF] uppercase">
              ...
              <div className="flex items-center justify-center w-12 h-12 rounded-full bg-[#F4FAFF] text-[#2199DF] group-hover:bg-[#2199DF] group-hover:text-white transition">
      ...
      {/* SERVICES - NEW HORIZONTAL CARDS */}
      <section
        id="services"
        ref={servicesSectionRef}
        className="relative py-24 overflow-hidden bg-[#F4FAFF]"
      >
        {/* Glow Background */}
        <div className="absolute top-0 left-0 w-[420px] h-[420px] bg-[#2199DF]/10 rounded-full blur-3xl"></div>
        <div className="absolute bottom-0 right-0 w-[420px] h-[420px] bg-[#202943]/10 rounded-full blur-3xl"></div>

        <div className="relative z-10 px-5 mx-auto max-w-7xl">
          {/* Heading */}
          <div className="mb-16 text-center services-heading">
            <p className="mb-4 text-sm font-black tracking-widest text-[#2199DF] uppercase">
              Business Solutions
            </p>

            <h2 className="text-4xl font-black text-[#202943] sm:text-6xl">
              Comprehensive Business Solutions
            </h2>

            <p className="max-w-3xl mx-auto mt-5 text-lg text-gray-600">
              From UPI payments to enterprise solutions, we have everything you need
              to handle payments efficiently.
            </p>
          </div>
          ...
          <div className="relative max-w-6xl mx-auto">
            {services.map((service, index) => (
              <div
                key={service.title}
                className={`phonepe-card sticky top-28  grid items-center gap-10 px-8 py-14 bg-white border border-[#dbeafe] rounded-[4rem] lg:grid-cols-2 overflow-hidden shadow-xl ${index === 0 ? "" : "-mt-40"
                  }`}
                style={{
                  zIndex: index + 1,
                }}
              >
                {/* Outline layers */}
                <div className="absolute inset-0 rounded-[4rem] border border-[#202943]/10 translate-x-3 -translate-y-3 pointer-events-none"></div>
                <div className="absolute inset-0 rounded-[4rem] border border-[#2199DF]/10 translate-x-6 -translate-y-6 pointer-events-none"></div>
                ...
                <div className="relative z-10 max-w-xl">
                  ...
                  <h3 className="text-4xl font-black leading-tight text-[#202943]">
                    {service.title}
                  </h3>
                  ...
                  <Link
                    to="/services"
                    className="inline-flex items-center gap-8 mt-8 text-lg font-black text-[#202943]"
                  >
                    Know More
                    <span className="flex items-center justify-center w-12 h-12 transition rounded-full hover:bg-[#F4FAFF]">
                      <ChevronRight className="w-8 h-8" />
                    </span>
                  </Link>
                </div>

                {/* RIGHT PHONEPE STYLE CARD */}
                <div className="relative z-10 flex justify-center lg:justify-end">
                  <div className="relative">
                    {/* back layers */}
                    <div className="absolute top-8 left-10 w-[280px] h-[330px] rounded-[2rem] bg-[#dbeafe]"></div>
                    <div className="absolute top-16 left-20 w-[280px] h-[330px] rounded-[2rem] bg-[#bfdbfe]"></div>

                    {/* Main Card */}
                    <div className="relative w-[300px] sm:w-[360px] h-[360px] rounded-[2rem] bg-gradient-to-br from-[#202943] to-[#2199DF] shadow-2xl p-8 text-white">
                      <div className="flex items-center gap-4 mb-8">
                        <div className="flex items-center justify-center w-12 h-12 rounded-full bg-white/20">
                          <service.icon className="w-7 h-7 text-white" />
                        </div>

                        <p className="text-lg font-black">SilanPay</p>
                      </div>

                      <div className="flex items-center justify-center mt-8">
                        <div className="relative flex items-center justify-center w-40 h-40 bg-white rounded-3xl shadow-xl">
                          <service.icon className="w-20 h-20 text-[#2199DF]" />

                          <div className="absolute flex items-center justify-center w-16 h-16 text-white rounded-full -bottom-6 -right-6 bg-[#202943]">
                            <CheckCircle className="w-8 h-8" />
                          </div>
                        </div>
                      </div>

                      <h4 className="mt-14 text-3xl font-black text-center">
                        Fast & Secure
                      </h4>

                      <p className="mt-3 text-sm font-semibold text-center text-white/80">
                        for every business payment
                      </p>
                    </div>
                  </div>
                </div>
      ...
      {/* STEPS - NEW TIMELINE */}
      <section className="py-24 text-white bg-[#07111f]">
        <div className="px-5 mx-auto max-w-7xl">
          <div className="mb-16 text-center fade-up">
            <h2 className="text-4xl font-black sm:text-6xl">
              Get Started in 3 Simple Steps
            </h2>
            <p className="max-w-3xl mx-auto mt-5 text-lg text-white/60">
              From registration to first transaction - complete setup in under
              10 minutes
            </p>
          </div>
          ...
          <div className="relative grid gap-6 lg:grid-cols-3">
            {steps.map((step) => (
              <div
                key={step.step}
                className="fade-up relative p-8 border border-white/10 bg-white/10 backdrop-blur-xl rounded-[2rem]"
              >
                <div className="absolute text-8xl font-black text-white/5 top-4 right-6">
                  {step.step}
                </div>

                <div className="relative">
                  <div className="flex items-center justify-center w-16 h-16 mb-6 text-white rounded-2xl bg-gradient-to-r from-[#2188C8] to-[#2199DF]">
                  ...
                  <ul className="mt-6 space-y-3">
                    {step.details.map((detail) => (
                      ...
                      >
                        <CheckCircle className="w-5 h-5 text-[#2199DF]" />
                        {detail}
                      </li>
                    ))}
                  </ul>

                  <div className="inline-flex items-center gap-2 px-4 py-2 mt-6 text-sm font-black rounded-full bg-white/10">
   ...
   {/* ADVANCED FEATURES - ORBIT DASHBOARD DESIGN */}
<section
  ref={successSectionRef}
  className="relative py-28 overflow-hidden bg-[#F4FAFF]"
>
  <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#2199DF]/15 rounded-full blur-3xl"></div>
  <div className="absolute bottom-0 left-0 w-[450px] h-[450px] bg-[#202943]/10 rounded-full blur-3xl"></div>

  <div className="relative z-10 px-5 mx-auto max-w-7xl">
    <div className="mb-16 text-center advanced-heading">
      <p className="mb-4 text-sm font-black tracking-widest text-[#2199DF] uppercase">
        Advanced Tools
      </p>
      ...
      <p className="max-w-3xl mx-auto mt-5 text-lg text-gray-600">
        Built-in tools and features that help you grow your business faster
      </p>
    </div>

    <div className="grid items-center gap-14 lg:grid-cols-2">
      {/* LEFT ORBIT VISUAL */}
      <div className="advanced-visual relative min-h-[560px] flex items-center justify-center">
        <div className="absolute w-[420px] h-[420px] rounded-full border border-[#2199DF]/20"></div>
        <div className="absolute w-[320px] h-[320px] rounded-full border border-[#202943]/10"></div>

        {/* Center Dashboard */}
        <div className="relative z-20 w-[300px] sm:w-[380px] p-6 bg-white shadow-2xl rounded-[2.5rem] border border-blue-100">
          <div className="flex items-center justify-between mb-6">
            <div>
              <p className="text-sm font-bold text-gray-500">SilanPay</p>
              <h3 className="text-2xl font-black text-[#202943]">
                Smart Dashboard
              </h3>
            </div>
            <div className="w-12 h-12 rounded-2xl bg-gradient-to-r from-[#202943] to-[#2199DF] flex items-center justify-center">
              <BarChart3 className="w-6 h-6 text-white" />
            </div>
          </div>

          <div className="space-y-4">
            <div className="p-4 rounded-2xl bg-[#F4FAFF]">
              <div className="flex justify-between mb-2 text-sm font-bold">
                <span>Success Rate</span>
                <span className="text-[#2199DF]">99.9%</span>
              </div>
              <div className="h-2 rounded-full bg-blue-100 overflow-hidden">
                <div className="advanced-bar h-full w-[92%] rounded-full bg-gradient-to-r from-[#202943] to-[#2199DF]"></div>
              </div>
            </div>

            <div className="grid grid-cols-2 gap-4">
              <div className="p-4 rounded-2xl bg-[#F4FAFF]">
                <p className="text-xs font-bold text-gray-500">Revenue</p>
                <h4 className="mt-2 text-xl font-black text-[#202943]">
                  ₹100Cr+
                </h4>
              </div>
              <div className="p-4 rounded-2xl bg-[#F4FAFF]">
        ...
        {advancedFeatures.slice(0, 6).map((feature, index) => {
          ...
          return (
            <div
              key={feature.title}
              className={`orbit-item absolute ${positions[index]} z-30`}
            >
              <div className="w-20 h-20 rounded-3xl bg-white shadow-xl border border-blue-100 flex items-center justify-center">
                <feature.icon className="w-9 h-9 text-[#2199DF]" />
              </div>
            </div>
          );
        })}
      ...
      <div className="space-y-5">
        {advancedFeatures.map((feature, index) => (
          <div
            key={feature.title}
            className="advanced-list-card group p-5 bg-white rounded-[2rem] shadow-lg border border-blue-100 hover:shadow-2xl transition"
          >
            <div className="flex gap-5">
              <div className="flex-shrink-0 w-14 h-14 rounded-2xl bg-gradient-to-r from-[#202943] to-[#2199DF] flex items-center justify-center group-hover:rotate-6 transition">
                <feature.icon className="w-7 h-7 text-white" />
              </div>

              <div>
                <div className="flex items-center gap-3 mb-2">
                  <span className="text-xs font-black px-3 py-1 rounded-full bg-[#E8F7FF] text-[#2188C8]">
                    {feature.badge}
                  </span>
                ...
                <h3 className="text-xl font-black text-[#202943]">
                  {feature.title}
                </h3>
                ...
                <div className="flex flex-wrap gap-2 mt-4">
                  {feature.points.map((point) => (
                    <span
                      key={point}
                      className="px-3 py-1 text-xs font-bold rounded-full bg-[#F4FAFF] text-gray-600"
                    >
                      {point}
                    </span>
                  ))}
      ...
      <section id="integration" className="py-24 bg-white">
        <div className="grid gap-8 px-5 mx-auto max-w-7xl lg:grid-cols-2">
          <div className="slide-left p-6 bg-[#07111f] text-white rounded-[2rem] shadow-2xl">
            <div className="flex items-center justify-between mb-5">
              <div>
                <h3 className="text-3xl font-black">Quick Integration</h3>
                <p className="mt-1 text-white/60">Ready in minutes</p>
              </div>

              <button
                onClick={copyCode}
                className="inline-flex items-center gap-2 px-4 py-2 font-black text-white rounded-xl bg-[#2199DF]"
              >
            ...
            <div className="flex gap-2 mb-4">
              {[
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-xl font-black ${selectedLanguage === id
                      ? "bg-[#2199DF] text-white"
            ...
            <pre className="p-5 overflow-x-auto text-sm leading-relaxed border rounded-2xl border-white/10 bg-black/40">
              <code>{codeExamples[selectedLanguage]}</code>
            </pre>
          </div>

          <div className="slide-right p-8 bg-[#F4FAFF] rounded-[2rem] shadow-xl">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-3xl font-black">24/7 Support</h3>
                <p className="mt-2 text-gray-600">We're always here to help</p>
              </div>
              <div className="flex items-center gap-2 px-4 py-2 text-sm font-black text-green-700 bg-green-100 rounded-full">
            ...
            <p className="mt-6 text-gray-600">
              Get instant support from our expert team anytime, anywhere. We're
            ...
            <div className="grid gap-4 mt-8">
              ...
              >
                <Phone className="w-6 h-6 text-[#2199DF]" />
                <div>
                  <h4 className="font-black">Phone Support</h4>
                  <p className="text-gray-500">+91 89842 89279</p>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-gray-500">Instant assistance available</p>
                </div>
              </a>
              ...
              <a
                ...
                className="flex items-center gap-4 p-5 bg-white shadow rounded-2xl"
              >
                <Mail className="w-6 h-6 text-[#2199DF]" />
                <div>
                  <h4 className="font-black">Email Support</h4>
                  <p className="text-gray-500">info@silanpay.com</p>
                </div>
              </a>
            </div>
          </div>
      ...
      <section className="py-24 bg-[#07111f] text-white">
        <div className="grid items-center gap-14 px-5 mx-auto max-w-7xl lg:grid-cols-2">
          ...
          <div className="grid gap-5 slide-right md:grid-cols-2">
            {[
              {
                icon: Rocket,
                title: "Innovation First",
              ...
              <div
                key={item.title}
                className="p-6 border rounded-3xl border-white/10 bg-white/10"
              >
                <item.icon className="w-9 h-9 text-[#2199DF]" />
        ...
        <div className="px-5 mx-auto max-w-7xl">
          <div className="mb-14 text-center fade-up">
            ...
            <p className="mt-5 text-lg text-gray-600">
              Choose a plan that matches your business.
            </p>
          </div>
          ...
          <div className="grid gap-6 lg:grid-cols-3">
            {pricingPlans.map((plan) => (
              <div
                key={plan.name}
                className={`scale-in relative p-8 rounded-[2rem] shadow-xl ${plan.popular
                    ? "bg-[#07111f] text-white lg:-translate-y-6"
                    : "bg-[#F4FAFF] text-[#202943]"
                  }`}
              >
                {plan.popular && (
                  <span className="absolute px-4 py-2 text-xs font-black text-white rounded-full top-5 right-5 bg-[#2199DF]">
                    Popular
                  </span>
                )}
                ...
                <p
                  className={`mt-2 ${plan.popular ? "text-white/60" : "text-gray-600"
                    }`}
                >
                  {plan.description}
                </p>
                ...
                <button
                  className={`w-full py-4 mt-8 font-black rounded-2xl ${plan.popular
                      ? "bg-[#2199DF] text-white"
                      : "bg-white text-[#202943]"
                    }`}
                >
                  Choose Plan
                </button>
        ...
        <div className="px-5 mx-auto max-w-7xl">
          ...
          <div className="grid gap-6 lg:grid-cols-3">
            {testimonials.map((item) => (
              <div
                key={item.name}
                className="fade-up p-8 bg-white shadow-xl rounded-[2rem]"
              >
      ...
      <section id="contact" className="py-24 bg-white">
        <div className="px-5 mx-auto max-w-7xl">
          <div className="fade-up relative overflow-hidden p-10 md:p-16 text-center text-white rounded-[3rem] bg-gradient-to-r from-[#202943] to-[#2199DF] shadow-2xl">
            <div className="absolute top-0 right-0 w-72 h-72 bg-white/10 rounded-full -mr-24 -mt-24" />

            <div className="relative">
              <h2 className="text-4xl font-black sm:text-6xl">
                Ready to Start with SilanPay?
              </h2>
              <p className="max-w-2xl mx-auto mt-5 text-lg text-white/75">
                Contact our team and launch your payment system quickly.
              </p>

              <div className="flex flex-col justify-center gap-4 mt-10 sm:flex-row">
                <a
                  href="tel:+918984289279"
                  className="inline-flex items-center justify-center gap-2 px-8 py-4 font-black text-[#202943] bg-white rounded-2xl"
                >
                ...
                <a
                  href="mailto:info@silanpay.com"
                  className="inline-flex items-center justify-center gap-2 px-8 py-4 font-black border border-white/30 rounded-2xl"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center justify-center gap-2 px-8 py-4 font-black bg-green-500 rounded-2xl"
                >
      ...
      {/* FOOTER */}
      <footer className="relative overflow-hidden bg-gradient-to-br from-[#202943] via-[#16213a] to-[#0b1220] text-white">
        {/* Glow Effects */}
        <div className="absolute top-0 left-0 w-96 h-96 bg-[#2199DF]/25 rounded-full blur-3xl"></div>
        <div className="absolute bottom-0 right-0 w-96 h-96 bg-cyan-400/10 rounded-full blur-3xl"></div>
        <div className="absolute inset-0 opacity-10 bg-[linear-gradient(to_right,#ffffff12_1px,transparent_1px),linear-gradient(to_bottom,#ffffff12_1px,transparent_1px)] bg-[size:60px_60px]"></div>

        <div className="relative z-10 px-5 pt-20 pb-10 mx-auto max-w-7xl">
          {/* Top Footer */}
          <div className="grid gap-12 pb-14 border-b border-white/10 md:grid-cols-2 lg:grid-cols-4">
            {/* Brand */}
            <div>
              <img
                src="/silanpaylogo.png"
              ...
              <p className="max-w-sm leading-relaxed text-white/70">
                Secure, fast and modern payment solutions for startups, merchants,
              ...
              <div className="flex gap-4 mt-6">
                {["F", "T", "L", "I"].map((item, i) => (
                  <a
                    key={i}
                    href="/"
                    className="flex items-center justify-center w-10 h-10 transition rounded-full bg-white/10 hover:bg-[#2199DF]"
                  >
            ...
            {/* Company */}
            <div>
              <h3 className="mb-6 text-xl font-black">Company</h3>

              <div className="space-y-4 text-white/70">
                <a href="/about" className="block hover:text-[#2199DF]">About Us</a>
                <a href="/careers" className="block hover:text-[#2199DF]">Careers</a>
                <a href="/blog" className="block hover:text-[#2199DF]">Blog</a>
                <a href="/contact" className="block hover:text-[#2199DF]">Contact</a>
              </div>
            </div>

            {/* Solutions */}
            <div>
              <h3 className="mb-6 text-xl font-black">Solutions</h3>

              <div className="space-y-4 text-white/70">
                <a href="/services" className="block hover:text-[#2199DF]">UPI Payments</a>
                <a href="/services" className="block hover:text-[#2199DF]">QR Payments</a>
                <a href="/services" className="block hover:text-[#2199DF]">Payment Gateway</a>
                <a href="/services" className="block hover:text-[#2199DF]">Enterprise API</a>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-4 text-white/70">
                <p>📞 +91 89842 89279</p>
                <p>📧 info@silanpay.com</p>
                <p>📍 Bhubaneswar, Odisha, India</p>
              </div>

              <a
                href="https://wa.me/918984289279"
                className="inline-flex items-center gap-2 px-5 py-3 mt-6 font-black text-white rounded-2xl bg-[#25D366]"
              >
                WhatsApp Support
              </a>
            </div>
          ...
          {/* Bottom */}
          <div className="flex flex-col items-center justify-between gap-4 pt-8 text-sm md:flex-row text-white/60">
            <p>© 2026 SilanPay. All rights reserved.</p>

            <div className="flex gap-6">
              <a href="/privacy" className="hover:text-[#2199DF]">Privacy Policy</a>
              <a href="/terms" className="hover:text-[#2199DF]">Terms of Service</a>
              <a href="/refund" className="hover:text-[#2199DF]">Refund Policy</a>
            </div>
          </div>
        </div>
      </footer>
